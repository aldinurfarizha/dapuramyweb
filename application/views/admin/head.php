<head>
  ...
  <title>Dapur Amy WebAdmin</title>
  ...
  <link rel="stylesheet" type="text/css" href=<?php echo base_url('assets/DataTables/media/css/dataTables.colVis.css')?>>
  ...
  <script type="text/javascript" src=<?php echo base_url('assets/dist/js/dataTables.colVis.js')?>></script>
